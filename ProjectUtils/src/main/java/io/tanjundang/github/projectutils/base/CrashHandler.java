package io.tanjundang.github.projectutils.base;
...
/**
 * Creator: TanJunDang
 * Date 2015-07-21-15:48
 * Description:自定义的奔溃信息记录实体,上报奔溃日志通过bugly
 */
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private String saveCrashInfoToFile(Throwable ex) {
        ...
        try {
            ...
            LogTool.e(TAG, "an error occured while writing report file...", ex);
        }
        return null;
    }
    ...
    public void collectCrashDeviceInfo(Context ctx) {
        try {
            ...
            LogTool.e(TAG, "Error while collect package info", e);
        }
        ...
        for (Field field : fields) {
            try {
                ...
                if (BuildConfig.DEBUG) {
                    LogTool.e(TAG, field.getName() + " : " + field.get(null));
                }
            } catch (Exception e) {
                LogTool.e(TAG, "Error while collect crash info", e);
            }
        }
    }
